...
export default function CarouselComponent() {
  return (
    ...
    >
      ...
      <div className="relative h-full w-full bg-gradient-to-r from-blue-100 to-blue-200">
        <img
          ...
          className="h-full w-full object-cover"
        />
        <div className="absolute inset-0 grid h-full w-full place-items-center bg-gradient-to-r from-purple-500 to-pink-500">
      ...
      <div className="relative h-full w-full">
        <img
          ...
          className="h-full w-full object-cover"
        />
        <div className="absolute inset-0 grid h-full w-full items-end bg-gradient-to-r from-purple-500 to-pink-500">
