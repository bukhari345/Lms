    ...
    <div className="w-full flex justify-center items-center">
      <div className="w-11/12">
        ...
        <div className="flex flex-col md:flex-row gap-x-10 h-full pb-20">
          <div className="border md:w-7/12 w-full h-full rounded-md bg-gradient-to-b from-blue-100 to-blue-200 border-gray-300">
          ...
          <div className="border my-7 md:mt-0 pt-5 pb-10 md:w-5/12 w-full h-full rounded-md bg-gradient-to-b from-blue-100 to-blue-200 border-gray-300">
