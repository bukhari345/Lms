...
const InstructorRegistrationPage: React.FC = () => {
  ...
  const handleSubmit = async (
    ...
    try {
      ...
      profilePhoto && formData.append("files", profilePhoto, "profilePic");
      certificate && formData.append("files", certificate, "certificateOne");
      certificateTwo &&
        formData.append("files", certificateTwo, "certificateTwo");
