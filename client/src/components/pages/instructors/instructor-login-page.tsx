...
const InstructorLoginPage: React.FC = () => {
  ...
  return (
    <div className="flex h-screen">
      <div className="flex-1 bg-[#9B00C187] flex items-center justify-center">
        <div className="text-white text-center">
          <h1 className="text-4xl font-bold">TEACHER’S LOGIN</h1>
      ...
      <div className="flex-1 flex items-center justify-center bg-gradient-to-r from-blue-100 to-blue-200">
        <div className="bg-gradient-to-b from-blue-100 to-blue-200 rounded-lg mx-10 shadow-xl border p-8 w-full max-w-md md:mx-auto md:p-10 lg:p-12">
