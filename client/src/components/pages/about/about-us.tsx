...
const AboutUs: React.FC = () => {
  return (
    <div className=" p-12">
      <h1 className="text-3xl ml-5 font-semibold mb-4">About E_Learning</h1>
      <div className="flex flex-col md:flex-row space-x-0 md:space-x-8">
        <div className="md:w-1/2 ml-5 ">
          <img
            ...
            alt="About E_Learning"
            className="rounded-lg  w-10/12 shadow-md"
          />
        </div>
        <div className="md:w-1/2 mt-5 md:mt-0">
          <p className="text-gray-600 mb-4">
            Welcome to E_Learning, your ultimate destination for online learning
          ...
          <p className="text-gray-600 mb-4">
            ...
            advancing your career, E_Learning provides you with a dynamic
          ...
          <p className="text-gray-600">
            Join E_Learning today and embark on a journey of knowledge,
