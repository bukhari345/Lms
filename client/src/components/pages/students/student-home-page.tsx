...
// import foodTruck from "../../../../public/img/Background.jpg";
  ...
  return (
    ...
    >
      <div className="text-center">
        ...
        <button
          className="mt-8 px-8 py-4 bg-white text-blue-500 font-semibold rounded shadow-lg"
          onClick={() => handleNavigate("/login")}
        >
          Student Login
        </button>
        <button
          className="mt-8 px-8 py-4 bg-white text-blue-500 font-semibold rounded shadow-lg ml-4"
          onClick={() => handleNavigate("/instructors/login")}
        >
          Teacher Login
        </button>
      </div>
