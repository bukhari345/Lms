...
export const Student: React.FC = () => {
  ...
  const headerClassName = `bg-gray-200 ${
    isHeaderVisible
    ...
    <>
      {isOnline ? (
        isLoggedIn && user === "instructor" ? (
          <>
            <div className="fixed inset-x-0 top-0 flex flex-col font-sans bg-white">
              {/* <InstructorHeader /> */}
              <div className="flex flex-1 bg-gray-200 ">
                ...
                <div className="flex  flex-col flex-1">
                  <div className="p-4 bg-white overflow-y-scroll h-screen">
                    <Outlet />
                  </div>
                </div>
              </div>
    ...
    <>
      {isOnline ? (
        isAdminLoggedIn && user === "admin" ? (
          <div className="bg-gray-200  items-center  flex justify-center font-sans overflow-y-hidden">
            <div className="w-80">
              <AdminSideNav />
            </div>
            <div className="flex-1 pl-4 h-screen bg-gray-200  max-h-full overflow-y-scroll mt-5">
